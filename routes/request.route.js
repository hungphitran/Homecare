...
router.post('/checkpaymentstatus', authTokenMiddleware, requestController.checkPaymentStatus)
router.get('/checksession', authTokenMiddleware, requestController.checkSession)
